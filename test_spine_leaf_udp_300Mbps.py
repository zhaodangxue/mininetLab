...
#这个脚本是用来测试spine-leaf网络的udp性能，h1发送udp包给h4，h4接收udp包，链路带宽为1Gbps，按iperf配置运行udp，以带宽速率300M(300Mbps)发送udp包10s
def log(s, col="green"):
...
def main():
    ...
    result = h1.cmd('iperf -u -c 10.4.4.100 -b 300M -t 10')
    info(result)
