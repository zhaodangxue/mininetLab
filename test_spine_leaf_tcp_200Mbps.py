...
#这个脚本是为了测试spine-leaf网络的tcp性能，链路带宽为200Mbps，按iperf默认配置运行tcp发包10s
def log(s, col="green"):
...
class SpineLeafTopo(Topo):
    def __init__(self):
        ...
        for i in range(2):
            for j in range(2, 6):
                self.addLink("r%d" % (i+1), "r%d" % (j+1),bw=200)
        ...
        self.addLink('r3','h1',bw = 200)
        self.addLink('r4','h1',intfName2='h1-eth2',params2={ 'ip' :'10.1.2.100/24'},bw = 200)
        self.addLink('r4','h2',bw = 200)
        self.addLink('r5','h2',intfName2='h2-eth2',params2={ 'ip' :'10.2.3.100/24'},bw = 200)
        self.addLink('r5','h3',bw = 200)
        self.addLink('r6','h3',intfName2='h3-eth2',params2={ 'ip' :'10.3.4.100/24'},bw = 200)
        self.addLink('r6','h4',bw = 200)
        self.addLink('r3','h4',intfName2='h4-eth2',params2={ 'ip' :'10.4.1.100/24'},bw = 200)
        return
